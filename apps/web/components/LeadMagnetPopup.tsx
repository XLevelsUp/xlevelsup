...
} from '@/actions/capture-email-lead';
      ...
      {!isSuccess ? (
        <div>
          <p className='text-gray-300 mb-6 leading-relaxed'>
            Want a{' '}
            <span className='gradient-text font-semibold'>Free SEO Audit</span>?
        ...
        <div className='text-center py-6'>
          <div className='w-16 h-16 mx-auto mb-4 rounded-full bg-linear-to-r from-cyan to-purple flex items-center justify-center'>
            <svg
